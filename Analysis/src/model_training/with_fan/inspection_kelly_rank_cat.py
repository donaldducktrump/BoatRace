...
def inspect_model():
    ...
    try:
        ...
        gbm_odds = lgb.Booster(model_file='boatrace_odds_model_rank_cat.txt')
    ...
    feature_names_odds = pd.read_csv('feature_names_odds_rank_cat.csv').squeeze().tolist()
    ...
    data['prob_0'] = (data['pred_score']+1)*0.5625
    ...
    # data.loc[data['艇番'] == 1, 'odds_pred'] = data.loc[data['艇番'] == 1, 'odds_pred'] -0.8
    # data['odds_pred'] = data['odds_pred'] -0.8
    ...
    # data.loc[data['艇番'] == 1, 'odds_pred_adjusted'] = data.loc[data['艇番'] == 1, 'odds_pred']
    ...
    print(filtered_data[['レースID','艇番','win_odds_mean','prob_0','win_odds1min','win_odds','odds_pred','bet_amount', 'payout']].head(50))
