...
def inspect_model():
    ...
    # 特徴量名の読み込み
    feature_names = pd.read_csv('feature_names_ranker.csv', header=None).squeeze().tolist()
    ...
    # Categorical encoding without resetting the index
    ...
    # Combine numerical and categorical features without resetting the index
    ...
    print("X_processed_new columns:", X_processed_new.columns.tolist())
