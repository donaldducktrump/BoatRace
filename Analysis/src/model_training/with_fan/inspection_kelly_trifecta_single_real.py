...
def inspect_model():
    ...
    date_files = {
        ...
        '2411': [f'2411{day:02d}' for day in range(1, 12)],
    }
    ...
    # EV計算のための減算値のリスト
    ev_subtract_values = [10,20,40,80]
    ...
    for ev_value in ev_subtract_values:
        ...
        print(trifecta_bets[trifecta_bets['Odds']<3.5])
        # 日付ごとの収益を計算
...
def calculate_trifecta_bets(trifecta_odds_df, data_boats, odds_data, total_capital=100000, unit=100, prob_threshold=0.01, ev_subtract=1.4):
    """
