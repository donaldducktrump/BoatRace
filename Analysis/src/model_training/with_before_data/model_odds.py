...
def create_model():
    ...
    date_files = {
        ...
        '2410': [f'2410{day:02d}' for day in range(16,21)],   # 241001 - 241008
    }
    ...
    date_files = {
        ...
        '2408': [f'2408{day:02d}' for day in range(1, 32)],  # 240801 - 240831
        '2409': [f'2409{day:02d}' for day in range(1, 31)],  # 240901 - 240930
        '2410': [f'2410{day:02d}' for day in range(1,19)],   # 241001 - 241008
    }
    data_list_odds = []
    for month in month_folders:
        for date in date_files[month]:
    ...
    features = ['会場', '艇番', '級別', '支部', '年齢', '体重', '全国勝率', '全国2連率',
                ...
                'ET', 'tilt', 'EST','ESC',
                'weather','air_t', 'wind_d', 'wind_v', 'water_t', 'wave_h',
                'win_odds1min', 'prob_0','prob_1','place_odds1min','win_odds_mean']
    ...
    # モデルの保存
    gbm.save_model('boatrace_odds_model.txt')

    # 特徴量名の保存
    X_processed.columns.to_series().to_csv('feature_names_odds.csv', index=False)
