...
def inspect_model():
    ...
    # 過去のwin_oddsを取得
    # month_folders = ['2210','2211','2212','2301','2302','2303','2304','2305','2306','2307','2308','2309','2310','2311','2312','2401','2402','2403','2404','2405','2406','2407','2408']
    ...
    # print(data[['レースID','艇番','prob_0','win_odds','odds_pred','bet_amount', 'payout']].head(500))
