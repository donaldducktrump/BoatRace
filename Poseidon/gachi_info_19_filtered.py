...
def main():
    ...
    for race_number in range(1, 13):  # 1Rから12Rまで
        ...
        if top_probability < 10:
            print(f"    Skipping this race because top probability is {top_probability}% which is less than 10%")
            continue
    ...
    # 結果をファイルに保存
    save_results_to_file(all_results, filename="shimonoseki_race_results_filtered.txt")
    # 結果をコンソールに出力
